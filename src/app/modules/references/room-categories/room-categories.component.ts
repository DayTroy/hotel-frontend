...
export class RoomCategoriesComponent implements OnInit {
  ...
  constructor(
    ...
    private readonly _roomCategoriesForms: RoomCategoriesForms
  ) {}
  ...
  public addRoomCategory(content: PolymorpheusContent<TuiDialogContext>): void {
  ...
  protected submit(observer: any): void {
    if (this.roomCategoryForm.valid) {
      ...
      const request$ = this.isEditMode
        ? this._roomCategoriesApi.update(formValue.roomCategoryId, formValue)
