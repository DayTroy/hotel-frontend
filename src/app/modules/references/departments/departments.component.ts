...
@Component({
    ...
    standalone: true,
    imports: [NgIf, TuiTable, AsyncPipe, NgFor, TuiCurrencyPipe, TuiButton, TuiStatus, TuiTextfield, FormsModule, ReactiveFormsModule, TuiInputNumber, TuiTextarea, TuiTextareaLimit, TuiButtonLoading, TuiCalendar, TuiTextfieldDropdownDirective, TuiInputDate, TuiInputTimeModule, TuiTextfieldControllerModule],
