...
export class JobPositionsComponent implements OnInit {
  ...
  constructor(
    ...
    private readonly _jobPositionsForms: JobPositionsForms,
  ...
  public addJobPosition(content: PolymorpheusContent<TuiDialogContext>): void {
  ...
  protected submit(observer: any): void {
    if (this.jobPositionForm.valid) {
      ...
      const request$ = this.isEditMode
        ? this._jobPositionsApi.update(formValue.jobPositionId, {
